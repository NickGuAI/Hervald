import { createHammurabiConfig, defaultConfigPath, writeHammurabiConfig, } from './config.js';
...
import { closePromptResources, promptMultiSelect, promptSecret, promptText, } from './prompts.js';
...
function printSelectedAgentInstructions(endpoint, apiKey, agents, autoConfigured) {
...
export async function runCli(args) {
    try {
        ...
        const agents = await promptMultiSelect('Select agents to connect:', AGENT_INSTRUCTIONS.map((instruction) => ({
